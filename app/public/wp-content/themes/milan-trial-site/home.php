...
<main>
    <!-- Hero Section -->
    <section id="hero-section" style="background-image: url('<?php echo $heroBackground ?>');" id="hero-section">
            ...
            <div class="row gx-5 align-items-center justify-content-center flex-row-reverse">
                <div class="col-lg-6">
                    <div class="my-5 text-center text-lg-start">
                        ...
                        <h2 class="text-uppercase fw-normal display-6 text-primary mb-4">When the Clouds</h2>
                ...
                <div class="col-lg-6">
                    <div class="position-relative mx-auto phone-wrapper">
                        ...
                        <img class="img-fluid rounded-3 my-5" src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/phone-02.png' ); ?>" alt="Phoone of Phone with Weather App Open">
            ...
            <div class="row gx-5 align-items-center justify-content-center">
                <div class="col-lg-6 ">
                    <div class="my-5 text-center text-lg-start ps-xl-5 ms-xl-5">
                        <img class="mb-4" src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/clouds-icon.png' ); ?>" alt="Icon of Clouds">
                        <h2 class="text-uppercase fw-normal display-6 text-primary mb-4">When the Sun</h2>
                        <p class="fw-normal mb-4 fs-4 col-lg-10">Variable information on the air humidity, the feeling of the weather, and the ability to share this with your friends. 
                        </p>
                        <div class="d-flex justify-content-center justify-content-lg-start">
                            <div class="ms-4 ms-lg-0 rounded-circle fw-bold d-flex align-items-center justify-content-center informational-circle position-relative bg-white">
                ...
                <div class="col-lg-6">
                    <div class="position-relative mx-auto phone-wrapper">
                        ...
                        <img class="img-fluid rounded-3 my-5" src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/phone-03.png' ); ?>" alt="Phoone of Phone with Weather App Open">
        ...
        <div class='container h-100 py-5 overflow-hidden'>
            <div class="row gx-5 align-items-center justify-content-center flex-row-reverse">
                <div class="col-lg-6">
                    <div class="my-5 text-center text-lg-start">
                        <img class="mb-4" src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/clouds-icon.png' ); ?>" alt="Icon of Clouds">
                        <h2 class="text-uppercase fw-normal display-6 text-primary mb-4">When the Rain</h2>
                        <p class="fw-normal mb-4 fs-4 col-lg-10">Variable information on the air humidity, the feeling of the weather, and the ability to share this with your friends. 
                        </p>
                        <div class="d-flex justify-content-center justify-content-lg-start">
                            <div class="ms-4 ms-lg-0 rounded-circle fw-bold d-flex align-items-center justify-content-center informational-circle position-relative bg-white">
                ...
                <div class="col-lg-6">
                    <div class="position-relative mx-auto phone-wrapper">
                        ...
                        <img class="img-fluid rounded-3 my-5" src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/phone-04.png' ); ?>" alt="Phoone of Phone with Weather App Open">
    ...
    <section id='testimoinals-section' class="py-5">
        <div class="container my-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-8 col-xl-6">
                    <div class="text-center">
                        <h2 class="text-uppercase fw-normal display-6 text-primary">What people are saying</h2>
    ...
    <!-- CTA Section -->
    <section id="cta-section" class='vh-50 bg-primary'>
        <div class='container d-flex align-items-center h-100 pt-5'>
            <div class="row gx-5 align-items-center justify-content-center h-100">
                <div class="col-lg-5 h-100 px-lg-0">
                    <div class="my-5 text-center text-xl-start h-100">
                        <h2 class="display-6 text-white mb-4 text-uppercase">How download the app?</h2>
                        <p class="lead text-white-50 mb-4 col-lg-11">Just download the app from the store Simple, nice and user-friendly application of the weather. Only relevant and useful information.</p>
